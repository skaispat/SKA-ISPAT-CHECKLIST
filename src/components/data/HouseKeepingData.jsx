        ...
        <AdminLayout>
            <div className="space-y-4 animate-in fade-in duration-500">
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-between items-start sm:items-center pb-6">
                    <div>
                        <h1 className="text-3xl font-semibold tracking-tight text-foreground">HouseKeeping Records</h1>
                    </div>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6 pt-2">
                    ...
                    {/* Upcoming Filters */}
                    {activeTab === 'upcoming' && (
                        <div className="grid grid-cols-2 sm:flex sm:flex-wrap items-end gap-3 p-1 animate-in fade-in slide-in-from-right-2">
                            {isAdmin && (
