  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gradient-to-br from-green-50 to-teal-50 dark:from-gray-900 dark:to-teal-950">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <div className="flex-shrink-0 p-4 border-t border-green-200 dark:border-teal-800 bg-white dark:bg-gray-950 flex flex-col md:flex-row items-center justify-between text-xs text-gray-500 dark:text-gray-400">
          <div className="hidden md:block w-1/3"></div>
          <div className="flex justify-center w-full md:w-1/3">
            <span>Powered by <span className="font-semibold text-[#991B1B]">Botivate</span></span>
          </div>
          <div className="flex justify-center md:justify-end w-full md:w-1/3 text-center md:text-right mt-2 md:mt-0">
            <span>© 2025 Botivate Services LLP. All rights reserved.</span>
          </div>
        </div>
      </div>
    </div>
